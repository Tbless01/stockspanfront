...
export const ProductListByEmail = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(`/product/products/${savedEmail}/${offset}/9`);
  ...
  <div className="prevNext">
      <button className="pagination-button" id="prevNe" onClick={handlePreviousClick}>
        Previous
      </button>
      <button className="pagination-button" id="prevNe" onClick={handleNextClick} disabled={isLastPage}>
        Next
      </button>
      </div>
    </>
